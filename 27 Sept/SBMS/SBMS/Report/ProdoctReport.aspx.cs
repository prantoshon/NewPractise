...
namespace SBMS.Report
{
    public partial class ProdoctReport : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            Session["Qurey"] = "SELECT       * FROM dbo.ReportView WHERE (Date BETWEEN CONVERT(DATETIME,'" + dateFrom + "',102) AND CONVERT(DATETIME,'" + dateTo + "',102))and (StatusUpadate = '"+drpStatus.SelectedItem.Text+"') ";
